        ...
        <div className="border-t border-gray-200 dark:border-gray-800 p-4 bg-white dark:bg-gray-900">
          ...
          <div className="flex gap-2">
            ...
            <textarea
              ...
              className="flex-1 border border-gray-300 dark:border-gray-700 rounded-lg p-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 resize-none focus:outline-none focus:ring-2 focus:ring-sky-500 dark:focus:ring-sky-600"
