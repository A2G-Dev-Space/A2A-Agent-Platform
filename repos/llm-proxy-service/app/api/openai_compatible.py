...
async def emit_trace_event(
    ...
    logger.info(f"[Trace] Emitting {event_type} for agent {agent_id}: {json.dumps(data)[:200]}")
...
async def proxy_gemini(
    ...
    """
    # TODO: Implement Gemini proxy with format conversion
    raise HTTPException(status_code=501, detail="Gemini provider not yet implemented")
