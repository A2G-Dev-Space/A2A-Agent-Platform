...
PLATFORM_LLM_ENDPOINT = os.getenv("PLATFORM_LLM_ENDPOINT", "http://localhost:9050/api/llm/trace/c285a23a-88fc-4bfc-9741-714f8ac0aade/v1")
...
if __name__ == "__main__":
    ...
    # AgentOS 서버 시작
    agent_os.serve(app="math_agent.agent:app", host="0.0.0.0", port=6020)
